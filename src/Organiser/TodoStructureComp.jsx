...
import { RemoveTaskComp } from "../reducers/CompletedTaskReducer";
...
const TodoStructureComp = ({ task, index }) => {
  ...
  const handleClick = (e) => {
    ...
    const filteredarr = completedtasks.filter((item) => item.id != cardid);
    dispatch(RemoveTaskComp(filteredarr));
  };
...
export default TodoStructureComp;
