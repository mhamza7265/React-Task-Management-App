              ...
              >
                <p>
                  ...
                  <span className="text-gray-italic">
                    {" "}
                    Receive notifications whenever we release a new update
                  </span>
                </p>
              </label>
            </div>
            <div className="mb-3 form-check form-switch">
              ...
              >
                <p>
                  ...
                  <span className="text-gray-italic">
                    {" "}
                    Receive notifications whenever a new task is assigned to you{" "}
                  </span>
                </p>
              </label>
            </div>
            <div className="mb-3 form-check form-switch">
              ...
              >
                <p>
                  ...
                  <span className="text-gray-italic">
                    {" "}
                    Receive notifications whenever a comment is added to a
            ...
            <div className="mb-3 form-check form-switch">
              ...
              >
                <p>
                  ...
                  <span className="text-gray-italic">
                    {" "}
                    Receive notifications whenever a document that you follow is
                    edited.{" "}
                  </span>
                </p>
              </label>
